...

{
    ...
    { 
        ...
        while(getline (in_file, line) )
        {
           ...
           else if (a_price == 0 || k1_price == 0 || k2_price == 0) 
           {
            cout << "Missing price information for flight code: " << flight_code1 << endl;
            // You can optionally print which specific price(s) are missing here
           }  

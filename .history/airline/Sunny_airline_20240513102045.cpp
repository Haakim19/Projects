...

{
    ...
    { 
        ...
        int adults = 0 , a_price = 0, kids1 = 0 , k1_price = 0, kids2 = 0 , k2_price = 0; //? a_price = adult ticket price , kids1 = kids 2 to 12 , k1_price = kids1 ticket price  
        ...
        {
           if (line.find("FLIGHT_CODE: " + flight_code) != string ::npos)
           {
            found = true;
           
            if (found && line.find("PRICE PER ADUULT: ") !=string :: npos )//extracting the values of price per adult
            {
               found_price1 = true;
             ...
             if (found && line.find("PRICE FOR KID(2 TO 12 YEARS): ") !=string :: npos )//extracting the values of price of kids from 2 to 12 years
            {
               found_price2 = true;
             ...
             if (found && line.find("PRICE FOR KID(UNDER 2 YEARS): ") !=string :: npos )//extracting the values of price of kids under 2 years
            {
               found_price3 = true;

    ...
    { 
        ...
        while(getline (in_file, line) )
        {
           if (line.find("FLIGHT_CODE: " + flight_code1) != string ::npos)
           {
            ...
            {
               found_price1 = true;
               string value1 = line.substr(line.find(":") + 1);
               cout << value1;
               
            }
             else if (found && line.find("PRICE FOR KID(2 TO 12 YEARS): ") !=string :: npos )//extracting the values of price of kids from 2 to 12 years
            {
               found_price2 = true;
               string value2 = line.substr(line.find(":") + 1);
               cout << value2;
               
            }
             else if (found && line.find("PRICE FOR KID(UNDER 2 YEARS): ") !=string :: npos )//extracting the values of price of kids under 2 years
            {
               found_price3 = true;
               string value3 = line.substr(line.find(":") + 1);
               cout << value3;
